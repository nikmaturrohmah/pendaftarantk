...
<body>
 <div id="wrapper" style="margin-top: 50px ">
	...
	<br>
	<a href="tambah_walmur.php">+ TAMBAH WALIMURID</a>
	<br/>
	<br/>
	<table border="1">
		<tr>
		...
		while($d = mysqli_fetch_array($data)){
			...
			<tr>
				...
				<td>
					<a href="edit_walmur.php?NIK_walmur=<?php echo $d['NIK_walmur']; ?>" class="btn-info">EDIT</a>
					<!-- <a href="hapus_walmur.php?NIK_walmur=<?php echo $d['NIK_walmur']; ?>">HAPUS</a> -->
					<a href="hide_walmur.php?NIK_walmur=<?php echo $d['NIK_walmur']; ?>" onclick="return confirm('Apakah Anda Yakin Untuk Menyembunyikan')" class="btn-info">HAPUS</a>
				</td>
			</tr>
			<?php 
			}
